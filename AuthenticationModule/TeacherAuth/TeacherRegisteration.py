...
def RegisterationStart(TkinterClassType):
    ...
    def SubmitForm():
        ...
        try:
            ...
            if not Name == "" and not Email == "" and not Age == "" and not PhoneNumber == "" and not Subject == "" and not Password =="":
                Db_Queries.insert_teacher(Name, Age, Email, Password, PhoneNumber, Subject, ProfileImageName.get())
                GoTologin()
            else:
    ...
    # ----------------------------- Registration Form-------------------------
    lbl_0 = Label(frame, text="Teacher Registration form", width=40, font=("bold", 36))
    ...
    # -----------------------------Subject-------------------------
    Subject_Label = Label(frame, text="Subject", width=40, font=("bold", 18))
    Subject_Label.grid(row=7, column=0, pady=10)

    Subject_Input = Entry(frame, width=20, font=("bold", 16))
    Subject_Input.grid(row=7, column=1, pady=10)
